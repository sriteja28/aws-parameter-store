...
variable "params" {
  default = [
    {
      name = "roboshop.dev.frontend.catalogue_url", value = "http://catalogue-dev.sritejadevops.com:8080/",
      type = "String"
    },
    ...
    {
      name = "roboshop.dev.frontend.shipping_url", value = "http://shipping-dev.sritejadevops.com:8080/",
      type = "String"
    },
    ...
    {
      name = "roboshop.dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.sritejadevops.com:27017/catalogue",
      type = "String"
    },
    ...
    {
      name = "roboshop.dev.user.mongo_url", value = "mongodb://mongodb-dev.sritejadevops.com:27017/users",
      type = "String"
    },
